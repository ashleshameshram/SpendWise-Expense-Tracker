...
export default function Dashboard({ savings,income, expense, balance }) {
  ...
  return (
    <div className="row g-4 mb-5 mx-4">

      {/* Current Balance */}
      <div className="col-lg-3 col-md-6">
        <div className="rounded-4 p-4 h-100 d-flex justify-content-between align-items-center"
          ...
          <div className="flex-grow-1">
            ...
            <div className="d-flex align-items-center">
              <i className="fa-solid fa-indian-rupee-sign me-2" style={{ fontSize: "22px" }}></i>
          ...
          <div className="d-flex justify-content-center align-items-center rounded-circle ms-3"
      ...
      <div className="col-lg-3 col-md-6">
        ...
        style={{background: "#E8F7EF",boxShadow: "0 4px 12px rgba(0,0,0,0.08)"}}>
          <div className="flex-grow-1">
            ...
            <div className="d-flex align-items-center">
              <i className="fa-solid fa-indian-rupee-sign me-2" style={{ fontSize: "22px", color: "#198754" }}></i>
              <h3 className="fw-bold mb-0">
